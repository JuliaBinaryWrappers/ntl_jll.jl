...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ntl_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7494e58d-996d-52b4-b7cf-f5d9dde4b521"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ntl", artifacts_toml) for e in artifacts["ntl"]]
...
if best_platform === nothing
    @debug("Unable to load ntl; unsupported platform $(triplet(platform_key_abi()))")
else
